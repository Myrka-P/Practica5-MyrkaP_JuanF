...
//equals de codigo
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + (int) (Double.doubleToLongBits(this.tiempoEnMinutos) ^ 
                (Double.doubleToLongBits(this.tiempoEnMinutos) >>> 32));
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Double.doubleToLongBits(this.tiempoEnMinutos)
                != Double.doubleToLongBits(other.tiempoEnMinutos)) {
            return false;
        }
