package ec.edu.ups.practica5.myrka_pallo.juan_fernandez.vista.compositor;
...
// controlador persona
    ...
    //crear lista cancion y cantante
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("ec/edu/ups/practica5/myrka_pallo/juan_fernandez/vista/compositor/Bundle"); // NOI18N
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("VentanaCrearCompositor.jPanel3.border.title"))); // NOI18N
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
       //crea un objeto compositor de datos ingresados
...
//valor ingresado cancion por el usuario , agrega la lista de cancion y luego limpia
...
//eliminar la cancion de la tabla de canciones y actualizar
...
//busca el cantante por codigo y si no es valido llega un mensaje
...
//agrega un cantante como cliente en una lista de cliente, y se actualiza, si no es valido te llega un mensaje
...
//borrar datos
    ...
    // imprimir los datos a una tabla canciones
    ...
    //imprimir los datos a una tabla cliente
