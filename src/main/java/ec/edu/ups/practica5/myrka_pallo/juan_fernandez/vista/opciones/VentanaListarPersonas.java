package ec.edu.ups.practica5.myrka_pallo.juan_fernandez.vista.opciones;
...
//localizar la cadena de texto- botones y etiqueta
    ...
    //carga todos los datod de las personad en una tabla,
    //mostrando su código, tipo, nombre, apellido, edad, nacionalidad y salario en filas separadas
    ...
    //Este método crea un nuevo DefaultTableModel con las columnas
    //"Código", "Titulo", "Letra" y "Tiempo". Luego, itera sobre la lista de canciones (lstCanciones) y agrega las filas correspondientes al
    //modelo de la tabla. Cada fila contiene el código, título, letra y tiempo de la canción.
    ...
    //modelo de una tabla 
    //Cada fila contiene el código, título, letra y tiempo del disco. Finalmente, se establece el modelo 
    //en la tabla tblDiscografia para mostrar los datos cargados.
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("ec/edu/ups/practica5/myrka_pallo/juan_fernandez/vista/opciones/Bundle"); // NOI18N
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(bundle.getString("VentanaListarPersonas.jPanel1.border.title"))); // NOI18N
        ...
        jLabel2.setText(bundle.getString("VentanaListarPersonas.jLabel2.text_1")); // NOI18N
...
//actualizar las tablas de canciones, clientes y discografía en función del tipo de persona seleccionada en la tabla de personas
    //cantante aparece discografia- compositor aparece canciones y cliente
