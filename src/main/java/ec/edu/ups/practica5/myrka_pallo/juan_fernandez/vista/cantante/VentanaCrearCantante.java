...
// controlador persona
   ...
   //crear lista del disco
    ...
    // cambia el texto para el idioma seleccionado
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
      //ingresa datos y los recopila en el disco, agregando a la lista discografia 
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
       // elimina los datos de la ventana
        borrarDatos();
        setVisible(false);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       //creacion de un objeto "cantante" datos ingresados
    ...
    private void cargarDatosTabla() {
        //datos de la discografia en una tabla
