...
//contructor
    public Compositor(int numeroDeComposiciones, int codigo, String nombre, String apellido, 
            int edad, String nacionalidad, double salario, List<Cancion> cancionesTop100Billboard,
            List<Cantante> clientes) {
